export const SignUpScreenLabel = {
  ...
  message: {
    ...
    emptyFieldEmail: 'Email is required',
    existUser: 'Username already taken',
    validUser: 'Username is available',
    existEmail: 'Email already taken',
    validEmail: 'Email is available',
    pleaseCheckUser: 'Please verify your username before registering',
    pleaseCheckEmail: 'Please verify your email before registering',
